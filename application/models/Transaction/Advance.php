	...
	{  if($_REQUEST['BUT'] =='SAVE')
	   {	
		 ...
		 else
	     {
	 	 ...
	 	 $qry="exec Exec_PostAdvance '".$_REQUEST['roomid']."' ,'".$_REQUEST['Amount']."','".$_REQUEST['paymode']."','".date('Y-m-d')."','".@$_REQUEST['bank']."','".@$_REQUEST['cardnumber']."','".@$_REQUEST['validate']."',".User_id.",'".$_REQUEST['Remark']."','".@$_REQUEST['idv']."','".str_replace(" ","",$_REQUEST['BUT'])."' ";	  
