...
class User extends CI_Model
{
	...
	{ 
	   ...
	   {		   
	     ...
	     {
		 	$qry= " Exec_User '".$_REQUEST['EmailId']."','".$_REQUEST['InActive']."','".$_REQUEST['UserGroup_Id']."','".base64_encode($_REQUEST['Password'])."',".Hotel_Id.",'".@$_REQUEST['idv']."','".$_REQUEST['Disper']."','".$_REQUEST['DisAmt']."','".str_replace(" ","",$_REQUEST['BUT'])."'";
			$res=$this->db->query($qry);
		 	$msg=$this->db->error(); 
