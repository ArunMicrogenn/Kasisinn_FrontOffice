  ...
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
	  ...
	  <tr>
	   ...
	   <td align="left"><input type="Hidden" value="<?php echo @$Cityid; ?>" name="City_id" id="City_id"/><input    type="text" placeholder="City" id="City" name="City" value="<?php echo @$City; ?>" class="scs-ctrl " />
	   <div class="City_id" ></div></td>
