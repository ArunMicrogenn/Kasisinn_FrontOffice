    ...
    <input type="hidden" name="idv" value="<?php echo @$resaddid; ?>" >
      <table class="FrmTable T-8" >
        ...
        <tr >
            ...
            <td><input type="text" style="display:none" class="scs-ctrl" value="<?php echo @$chno; ?>" placeholder="Card Number" name="cardnumber" id="cardnumber" > <div style="display:none" id="errcardnumber" class="cardnumber"></div></td>
...
<script> 
 ...
 btn.addEventListener("click", () => {
  ...
  if(paymode.value !=1 && paymode.value != 13 ){
