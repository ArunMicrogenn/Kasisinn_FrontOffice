    ...
    <input type="hidden" name="idv" value="<?php echo @$ID; ?>" >
      <table class="FrmTable T-8" >
        ...
        <tr>
          ...
          <td align="left"><input type="text" placeholder="Advance" id="Advance" readonly name="Advance" value="<?php echo $Amount; ?>" class="scs-ctrl" />
        ...
        <tr >
          ...
          <td><select name="bank" style="display:none"  class="scs-ctrl" id="bank"><option value="">--Bank--</option>
            ...
            ?>
            </select> <div style="display:none" id="bankdiv" class="bank" ></div>
          </td>
          <td><input style="display:none" type="date" class="scs-ctrl" id="validate" name="validate"><div style="display:none" id="validatediv" class="validate" ></div></td>   
        </tr>
        <tr>
          <td align="right">&nbsp;</td>
          <td align="right">&nbsp;</td>
