  ...
  <div class="the-box F_ram">
	...
	<form action="" method="POST">
        ...
        <tr>
          ...
          <td align="left"><input type="text" value="<?php echo date('d-m-Y'); ?>" id="frmdate" name="Fdate"   class="scs-ctrl Dat1" />
            <div class="Type" ></div></td>
            <td align="right" class="F_val">To Date</td>
          <td align="left"><input type="text" value="<?php echo date('d-m-Y'); ?>" id="todate" name="Tdate"   class="scs-ctrl Dat1" />
            <div class="Type" ></div></td>        
