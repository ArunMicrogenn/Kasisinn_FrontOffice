  ...
  <div class="the-box F_ram">
	...
	<form action="" method="POST">
        ...
        <tr>
          ...
          <td align="left"><input type="date" value="<?php if(@$_POST['frmdate']){echo @$_POST['frmdate']; }else{echo date('Y-m-d');} ?>" id="frmdate" min="<?php echo date('Y-m-d'); ?>" name="frmdate"  max="<?php echo date('Y-m-d'); ?>"  class="scs-ctrl " />
