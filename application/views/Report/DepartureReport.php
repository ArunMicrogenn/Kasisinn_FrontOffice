...
$this->pweb->Cheader('Report','Todays Depature Report');
$this->pfrm->FrmHead6('Report /Todays Depature Report',$F_Class."/".$F_Ctrl,$F_Class."/".$F_Ctrl."_View");
  ...
  <div class="the-box F_ram">
	...
	<form action="" method="POST">
        ...
        <tr>
          ...
          <td align="left"><input type="Date" value="<?php echo date('Y-m-d'); ?>" id="frmdate" name="frmdate" min="<?php echo date('Y-m-d'); ?>" max="<?php echo date('Y-m-d'); ?>" class="scs-ctrl" />
            <div class="Type" ></div></td>
            <td align="right" class="F_val">To Date</td>
          <td align="left"><input type="date" value="<?php echo date('Y-m-d'); ?>" id="todate" name="todate" min="<?php echo date('Y-m-d'); ?>" max="<?php echo date('Y-m-d'); ?>"  class="scs-ctrl " />
            <div class="Type" ></div></td>        
  ...
  <div class="the-box D_IS" ></div>
    ...
    <div id="printing" class="col-sm-12">
        ...
        <table class="table table-bordered table-hover"  >  
		    <div>
				<h3 class="text-center">Today's Depature Report  <?php echo date('d-m-Y', strtotime($_POST['frmdate'])); ?> To <?php echo date('d-m-Y', strtotime($_POST['todate'])); ?><h3>
		    </div>           
		   <tbody>
		    <?php 
			 $i=1;	
