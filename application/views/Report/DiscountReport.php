  ...
  <div class="the-box D_IS" ></div>
    ...
    <div id="printing" class="col-sm-12">
        ...
        <table class="table table-bordered table-hover"  >  
		    <div>
				<h3 class="text-center">Discount Report  <?php echo date('d-m-Y', strtotime($_POST['frmdate'])); ?> To <?php echo date('d-m-Y', strtotime($_POST['todate'])); ?><h3>
		    </div>           
		   <tbody>
		    <?php 
			 $i=1;	
			 ...
			 $advance= $exec->num_rows();
			  ...
			  foreach ($exec->result_array() as $rows)
			  {
                ...
                echo '<td  style="text-align: left;">'.$rows['discount'].'</td>';
                echo '<td  style="text-align: left;">'.$rows['discountper'].'</td>';
                echo '<td  style="text-align: left;">'.$rows['resson'].'</td>';			
			  }
