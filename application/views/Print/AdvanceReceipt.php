    ...
    <fieldset>
     <div id="printing">
		...
		<tr id="dataTable1">
		 ...
		 <?php  $sql=" select PayMode,rem.billremark,rem.Amount,Firstname,RoomNo,Receiptno,PrintingName,rpttime,rptdate,Noofpersons, mb.bank,rem.yearprefix  from Trans_Receipt_mas rem
			 ...
			 left join mas_bank mb on mb.bankid = rem.bank 
