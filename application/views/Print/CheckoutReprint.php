...
$this->pfrm->FrmHead4('Print / Checkout Reprint','CheckoutBill',$F_Class."/".$F_Ctrl,$F_Class."/".$F_Ctrl."_View");
				   ...
				   <tr>
    			    ...
    			    <tfoot>
						...
						<tr>
						  ...
						  <td style="width:10%;text-align:right;"><b><?php echo number_format($NETAMOUNT,2); ?></b></td>						 
