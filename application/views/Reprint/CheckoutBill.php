  ...
  <div class="the-box F_ram">
   <fieldset>
		<form action="" method="POST">
			...
			<td align="left"><input type="text" value="<?php echo date('d-m-Y'); ?>" id="frmdate" name="frmdate"   class="scs-ctrl Dat1" />
				<div class="Type" ></div></td>
				<td align="right" class="F_val">To Date</td>
			<td align="left"><input type="text" value="<?php echo date('d-m-Y'); ?>" id="todate" name="todate"   class="scs-ctrl Dat1" />
				<div class="Type" ></div></td>        
...
<div>
        ...
        <table class="table table-bordered table-hover"  >         
		   <tbody>
			...
			//Edit By Pavithra.M 03/01/2024 FOR BILL FORMAT
			
			echo '<td style="text-align: center;">
			<a href="#" onclick="showPrintOptions(' . $rows['Checkoutid'] . ')">
				<i class="fa fa-eye"></i>
			</a>
		</td>';
...
<script>
function showPrintOptions(checkoutId) {
    Swal.fire({
        ...
        html: `
            <select id="printOption" class="swal2-input">
                ...
                <option value="checkout">Checkout Bill</option>
            </select>
        `,
        icon: 'question',
        ...
        if (result.isConfirmed) {
            ...
            if (selectedOption === 'summary') {
                // Redirect to Summary Print URL
                window.location.href = `${scs_index}Reprint/CheckoutSummaryReprint?Checkoutid=${checkoutId}`;
            } else if (selectedOption === 'checkout') {
                // Redirect to Checkout Print URL
